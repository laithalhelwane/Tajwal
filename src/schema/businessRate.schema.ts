...
export const createBusinessRateSchema = object({
  body: object({
    ratingValue: number({
...
export type createBusinessRateInput = TypeOf<typeof createBusinessRateSchema>;
